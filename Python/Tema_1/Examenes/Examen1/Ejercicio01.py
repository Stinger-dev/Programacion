...
opciones = {'tijera':tijera,'papel':papel, 'piedra':piedra,'lagarto':lagarto,'spock':spock} #diccionario = {clave:definicion}
...
while not (r1=='spock'and r2=='spock'):
    ...
    while not(r2 in opciones): #busca que     
    ...
    if not (r1=='spock'and r2=='spock'): #Asi puedo salir directaamente del buvle sin hacer el codigo que sigue 
        ...
        elif r1 in opciones[r2]: #Compruebo que r1 este en la relacion que le meto con el diccionario a r2, si esta es que pierde 
            print(f' {r1.capitalize()} pierde ante {r2}.')#si r1 esta en la lista de las opciones a la que gana r2, entonces r1 pierde contra r2
        else :

...
public class Nota implements Comparable<Nota> {
	...
	public Nota(String texto) {
		...
		this.fechaUltimaModificacion = this.fechaCreacion; // Ponemos que la fecha de modificacion porn defecto sea la
															// de creacion, como el Windows
	...
	public boolean isModificado() {
		return !this.fechaCreacion.equals(this.fechaUltimaModificacion); // si la fecha es distinta significa que esta
																			// modificado
	}
	...
	public String toString() {
		return String.format("Fecha de creacion: %s \n" + "Fecha de modificacion: %s \n" + "%s",
				this.fechaCreacion.toString(), this.fechaUltimaModificacion.toString(), this.texto);
	}

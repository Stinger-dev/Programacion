...
public class Recomendacion extends Publicacion {
	...
	public String toString() {
		/**
		 * FORMATO REQUERIDO (Esto se podria poner en la superclase pero como el uml
		 * pide un to string en cada subclase, alla vamos) Recomendación. Publicación:
		 * <texto de la publicación> Realizada por: <login del usuario> Valoración:
		 * <valoración> Fecha de publicación: <fecha de publicación> Número de
		 * estrellas: <número de estrellas>
		 * 
		 */
		return String.format("%s \n" + "%s \n" + "Número de estrellas: %s", this.getClass().getSimpleName(),

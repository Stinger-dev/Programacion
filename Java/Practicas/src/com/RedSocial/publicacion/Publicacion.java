...
public abstract class Publicacion implements Comparable<Publicacion>, Valorable {
	...
	@Override
	public int hashCode() {
		return Objects.hash(codigo, fechaCreacion, texto, usuario, valoracion); // No se que especificamente quiere en
																				// el hash, asi que tp' pa' éntro
	}
	...
	public boolean valorar(String valoracion) {
		...
		return success; // Supongo que es una bandera de exito, pq en el uml lo pone pero no he
						// encontrado aun el
	}
	...
	public String toString() {
		/**
		 * FORMATO REQUERIDO Publicación: <texto de la publicación> Realizada por:
		...
		return String.format(
				...
				this.texto, this.usuario.getLogin(), this.valoracion, this.getFechaCreacion());
	}

	@Override
	public int compareTo(Publicacion obj) {
		return (this.valoracion == obj.valoracion) ? this.fechaCreacion.compareTo(obj.fechaCreacion)
				: this.valoracion - obj.valoracion;
	}

	public boolean isAnterior(Publicacion obj) {
		return this.fechaCreacion.isBefore(obj.fechaCreacion); // Recordar para un futuro, tiene pinta de que lo voy a
																// necesitas
	}

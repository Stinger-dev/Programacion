...
public class CadenaUtils {
	...
	public boolean esCapicua() {
		boolean resultado = false;
		if (this.cadena != null && !this.cadena.isEmpty() ) { //Esto seria mas rapido si diractamente pongo una exepcion a todo y si peta devuelvo false, pero dudo que eso sea lo que se pide
			boolean esNumero;
			try {

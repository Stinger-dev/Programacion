...
public class Serie {
	...
	public void annadirTemporada( String nombreTemporada) throws SerieException {
		Temporada tmp = new Temporada(nombreTemporada);
		if(this.temporadas.contains(tmp)) {
			throw new SerieException("Ya existe temporada");
		}
		this.temporadas.add(tmp);
	}
	...
	public String listadoTemporadasPorNotaMedia() {
		List<Temporada> tmp = new ArrayList<>(this.temporadas);
		tmp.sort(new ComparatorTemporadaNotaMedia());
		return tmp.toString();
	}
	...
	public String listadoTemporadasPorNumeroDeCapitulos() {
		List<Temporada> tmp = new ArrayList<>(this.temporadas);
		tmp.sort(new CompartorNumeroEpisodos());
		return tmp.toString();
	}
	...
	protected ArrayList<Temporada> getTemporadas() {
		return temporadas;
	}

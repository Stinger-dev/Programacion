	...
	public boolean esExclusivamenteFemenino() {
		...
		while (it.hasNext() && !encontrado) {
			if(it.next().getSexo() == 'H') {
				//Hacinedolo asi mejoro un poco la cantidad que veces que se ejecuta el codigo, pq en caso que el masculino sea el primero, se para 
				encontrado = true;
			}
		}

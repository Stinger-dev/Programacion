...
while peso >= 0:   
    ...
    if peso >= 0:
        ...
        tipoVida = input(" Indique su tipo de vida (Sedentaroia / Activa / Muy activa): ").upper().strip() #Upper sirve para normalizar todas las letras a mayusculas y el stripsirve para borrar los espacios y evitar errores
        ...
        while not (tipoVida in tiposVida): #Compruebo que el tipo de vida que ha introducido existe en el vector de tipos de vida
            tipoVida = input(" Tipo de vida no valido (Sedentaroia / Activa / Muy activa), inserte un valor valido: ").upper().strip()
